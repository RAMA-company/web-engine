...
mkdir -p minimal-landing-builder/{styles,scripts,assets,.github/workflows}

# Create index.html file
cat > minimal-landing-builder/index.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Minimal Landing Page Builder</title>
...
<body>
    <div class="container">
        <!-- Hero Section -->
        <section class="hero">
            <h1>Minimal Landing Page Builder</h1>
            <p>Create beautiful, responsive landing pages in seconds. No coding required.</p>
            <div class="color-palette">
                <div class="color-option" style="background: #4F46E5;"></div>
                <div class="color-option" style="background: #2563EB;"></div>
                <div class="color-option" style="background: #059669;"></div>
                <div class="color-option" style="background: #D97706;"></div>
    ...
    <footer>
        <p>Minimal Landing Page Builder • Optimized for GitHub Pages</p>
    </footer>
    
    <div class="notification" id="notification">Changes saved locally!</div>
...
cat > minimal-landing-builder/styles/main.css << 'EOF'
:root {
    --border-radius: 12px;
...
# Create builder.js file
cat > minimal-landing-builder/scripts/builder.js << 'EOF'
...
# Create deploy.yml
cat > minimal-landing-builder/.github/workflows/deploy.yml << 'EOF'
...
# Create README.md
cat > minimal-landing-builder/README.md << 'EOF'
# Minimal Landing Page Builder
...
echo "Minimal Landing Page Builder repository created successfully!"
echo "To use:"
echo "1. cd minimal-landing-builder"
echo "2. Open index.html in your browser"
echo "3. Start building your landing page"
